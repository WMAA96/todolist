...
function setup() {
    ...
    (0,_logic__WEBPACK_IMPORTED_MODULE_0__.loadProject)();
    ...
    submit.addEventListener("click", () => {
        ...
        (0,_logic__WEBPACK_IMPORTED_MODULE_0__.createTodo)(title.value, description.value, duedate.value, currentProject.textContent);
...
const appendTodos = (todo) => {
    ...
    removeTodo.addEventListener("click", (e) => {
        ...
        (0,_logic__WEBPACK_IMPORTED_MODULE_0__.deleteTodo)(pname.textContent, li.textContent.split(" due on"));
        e.target.parentNode.parentNode.removeChild(e.target.parentNode);
    })
...
(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(2022,0,1), 'dd/MM/yyyy');

function createTodo(title, description, duedate, currentProject) {

    let todo = new _todo__WEBPACK_IMPORTED_MODULE_1__["default"](title, description, duedate);
...
class Todo {
    constructor(title, description, duedate) {
        ...
        set duedate(value) {
            console.log("YUP");
            value = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(value), "dd,MMM,yyyy");
            this._duedate = value;
        }
